...
void read_pid_gain(void)
{
	...
	fp = fopen("/home/amap/w_catkin_ws/src/opencv_line_detection/pid_gain_line_trace.txt","r");
	if(fp == NULL) 
	{
...
void read_roi_data(void)
{
	...
	fp = fopen("/home/amap/w_catkin_ws/src/opencv_line_detection/vision_roi.txt","r");
...
int main(int argc, char **argv)
{
    ...
    image_transport::ImageTransport it(nh);
    image_transport::Subscriber sub = it.subscribe("/camera/image1", 1000, imageCallback);
