...
void steering_angle_Callback(const std_msgs::Float32::ConstPtr& msg)
{
    ...
    double angular_data = steering_angle;
...
void speed_of_steering_angle()
{
	double linear_data = 240.0;
/*
	if(steering_angle >= -40 && steering_angle <= -24)
	{
		linear_data = 138;
	}
	if(steering_angle >= -23 && steering_angle <= -18)
	{
		linear_data = 141;
	}
	if(steering_angle >= -17 && steering_angle <= -12)
	{
		linear_data = 144;
	}
		if(steering_angle >= -11 && steering_angle <= -6)
	{
		linear_data = 147;
	}
	if(steering_angle >= -5 && steering_angle <= 5) // 90
	{
		linear_data = 150;
	}
	if(steering_angle >= 6 && steering_angle <= 11)
	{
		linear_data = 147;
	}
	if(steering_angle >= 12 && steering_angle <= 17)
	{
		linear_data = 144;
	}
	if(steering_angle >= 17 && steering_angle <= 23)
	{
		linear_data = 141;
	}
	if(steering_angle >= 24 && steering_angle <= 40)
	{
		linear_data = 138;
	}
*/
...
/*
	if(steering_angle >= -45 && steering_angle <= -26)
	{
		linear_data = 160;
	}
	if(steering_angle >= -25 && steering_angle <= 25) // 90
	{
		linear_data = 200;
	}
	if(steering_angle >= 26 && steering_angle <= 45)
	{
		linear_data = 180;
	}
*/
...
int main(int argc, char **argv)
{
    ...
    while (ros::ok())
    {
		...
		//printf("steering_angle_camera : %lf \n", steering_angle);
